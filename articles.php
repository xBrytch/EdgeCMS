...
<?php } ?>
				<h5 class="card-title mb-4"><a href="/news/<?php echo $new['id']; ?>" data-toggle="tooltip" title="" data-original-title="<?php echo filtro($new['title']); ?>"><span class="profile-news"> 
<?php echo filtro(mb_strimwidth($new['title'], 0, 46, "...")); ?>                    
</span></a></h5>
		<div class="card-text">
...
<?php if(Loged == TRUE) { ?>
<a href="/home/<?php echo $new['author']; ?>"><span class="profile-news"> 
<?php echo $new['author'];?>                    
</span></a> 
<?php } ?>
<?php if(Loged == FALSE) { ?>
...
<?php } ?>
			<span style="cursor:default;color: white!important;" class="ml-auto text-muted" style="cursor:default"><i class="fas fa-calendar-alt ml-3 mr-1"></i><?php echo GetLast($new['date']); ?></span>			
		</div>
	</div>
		</div>
	</div>
