...
<section>
	...
	<div class="text-center"> 
		<h4 class="mb-4">Pausa para Manutenção</h4>
		<p class="text-muted mb-0">Tivemos que fechar nosso Hotel temporariamente para realizar alguns ajustes e melhorar a sua jogabilidade.</p>
		<hr>
