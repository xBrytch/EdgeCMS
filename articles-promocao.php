...
<?php } ?>
	...
	<div class="section-title" style="cursor:default"><h3 style="margin-left: -15px;"><?php echo $Lang['news.have1']; ?> <b><?php echo mysqli_num_rows(mysqli_query(connect::cxn_mysqli(),"SELECT * FROM cms_news WHERE category = 'promocao'")) ?></b> <?php echo $Lang['news.have2']; ?></h3></div>
		<div class="row">
